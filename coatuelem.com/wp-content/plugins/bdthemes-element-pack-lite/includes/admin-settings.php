        ...
        ?>
            ...
            <div class="ep-dashboard-panel" bdt-scrollspy="target: > div > div > .bdt-card; cls: bdt-animation-slide-bottom-small; delay: 300">
                ...
                <div class="bdt-grid" bdt-grid bdt-height-match="target: > div > .bdt-card">
                    <div class="bdt-width-2-5@m ep-welcome-banner">
                        <div class="ep-welcome-content bdt-card bdt-card-body">
                            ...
                            <p>Thanks for joining the Element Pack Pro family.
                    ...
                    <div class="bdt-width-2-5@m">
                        <div class="bdt-card bdt-card-body bdt-card-red ep-genarate-idea">
                            ...
                            <p style="max-width: 690px;">
                              Designing an element might be so tough, I might not able to do it! You often may think like that but it’s not true. We have made the best tutotials and walk throughs for each and every elements, widgets, blocks that anyone will be able to do it. Lets visit the documentation web portal and learn more about  your desired elements to make the next coolest website on the internet.
                            </p>
                            <a class="bdt-button bdt-btn-red bdt-margin-small-top" target="_blank" rel="" href="https://elementpack.pro/element-pack-knowledge-base/">Go knowledge page</a>

                        </div>
                    </div>

                    <div class="bdt-width-1-5@m">
                        <div class="bdt-card bdt-card-body bdt-card-blue ep-facebook-community">

                            <h1 class="ep-feature-title">Join Facebook Group</h1>
                            <p style="max-width: 690px;">
                              Join our Element Pack Community to get instant help and some exciting offer frequently.
                            </p>
                            <a class="bdt-button bdt-btn-blue bdt-margin-small-top" target="_blank" rel="" href="https://www.facebook.com/groups/elementpack/">Join Now</a>
                            ...
                            <ul class="bdt-list bdt-list-divider" bdt-lightbox>
                                <li>
                                    <a href="https://youtu.be/fzq1GsNcPAw">
                                        <h4 class="ep-link-title">What's New in Version V5.2 (Pro)</h4>
                                    </a>
                                </li>
                                <li>
