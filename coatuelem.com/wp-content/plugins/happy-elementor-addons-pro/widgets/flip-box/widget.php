                        ...
                        <div class="ha-flip-box-front-inner">
                            ...
                            <div class="ha-text">
                                <?php if ( $settings['front_title'] ) : ?>
                                    <h2 <?php $this->print_render_attribute_string( 'front_title' ); ?>><?php echo ha_kses_basic( $settings['front_title'] ); ?></h2>
                                <?php endif; ?>
                        ...
                        <div class="ha-flip-box-back-inner">
                            ...
                            <div class="ha-text">
                                <?php if ( $settings['back_title'] ) : ?>
                                    <h2 <?php $this->print_render_attribute_string( 'back_title' ); ?>><?php echo ha_kses_basic( $settings['back_title'] ); ?></h2>
                                <?php endif; ?>
