...
class Dashboard {
    ...
    public static function add_tabs( $tabs ) {
        $tabs['pro'] = [
            'title' => esc_html( hapro_has_valid_license() ? __( 'License', 'happy-addons-pro' ) : __( 'Activate License', 'happy-addons-pro' ) ),
    ...
    public static function add_action_links( $default_links ) {
        ...
        array_push( $links, sprintf( '<a style="color:#e2498a; font-weight: bold;" href="%s">%s</a>',
            ...
            hapro_has_valid_license() ? __( 'License', 'happy-addons-pro' ) : __( 'Activate License', 'happy-addons-pro' )
        ) );
